...
namespace Parking.Mqtt.Core.Handlers
{
    ...
    {
        private const string _cachedSensorsList = "sensorsList";
        private readonly ICacheService _cache;
        private readonly ILogger _logger;
        private readonly IParkDataRepository _parkDataRepo;
        public DataReceivedHandler(ILogger<DataReceivedHandler> logger, ICacheService cache,  IParkDataRepository parkDataRepo)
        {
            _logger = logger;
            _cache = cache;
